						     ...
						     <script type="text/javascript">
									    	...
									    	$('.submit-form').click(function() {
									    		...
									    		$.ajax({
													 ...
													 data: creatQueryString2(cartypename,detail_date,detail_time_no,detail_time,county,district,address,arrival_address),
													 /* dataType: "json", */
									    	...
									    	function creatQueryString2(cartypename,detail_date,detail_time_no,detail_time,county,district,address,arrival_address){
												
												var queryString= {"action":"insert", "cartypename":cartypename, "detail_date":detail_date, "detail_time_no":detail_time_no, "detail_time":detail_time, "county":county, "district":district,"address":address , "arrival_address":arrival_address, "passenger_name":"R群","passenger_phone":"0979498988","sendcar_status":"A"};
